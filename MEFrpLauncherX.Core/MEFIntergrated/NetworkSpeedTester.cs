...
namespace MEFrpLauncherX.Core.MEFIntergrated
{
    public class NetworkSpeedTester
    {
        ...
        public async Task<int> FindFastestUrlIndexAsync( IEnumerable<string> urls, CancellationToken cancellationToken = default)
        {
            return await FindFastestUrlIndexAsync(cancellationToken, urls.ToArray());
        }
