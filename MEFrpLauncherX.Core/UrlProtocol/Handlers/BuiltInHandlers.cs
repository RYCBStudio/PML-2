...
{
    public bool CanHandle(string url) => url.StartsWith("pml2://startProxy/");
...
{
    public bool CanHandle(string url) => url.StartsWith("pml2://about");
...
{
    public bool CanHandle(string url) => url.StartsWith("pml2://startMC");
