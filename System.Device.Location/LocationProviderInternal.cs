...
internal sealed class GeoLocationProviderInternal : GeoLocationProviderBase, ILocationEvents, IDisposable
{
    ...
    public override void Start()
    {
        if (!m_started)
        {
            ...
            else
            {
                ...
                ThreadPool.QueueUserWorkItem(GetInitialLocationData, null);
#if _DEBUG
        ...
        Utility.Trace("GeoLocationProviderInternal.Start:" +
                      " m_started: " + m_started +
                      " Status: " + Status +
                      " m_curLocation: " + m_curLocation.Coordinate);
    }
    ...
    private static readonly GeoLocationStatus[] m_geoStatusMap =
    [
    ...
    {
        Utility.Trace("GeoLocationProviderInternal.Dispose(disposing=)" + disposing + ")");
