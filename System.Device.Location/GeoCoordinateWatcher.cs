...
internal abstract class GeoCoordinateWatcherBase
{
    ...
    public virtual GeoPositionPermission Permission
    {
        get;
        protected set;
    }

    public virtual GeoPositionStatus Status
    {
        get;
        protected set;
    }

    public virtual GeoPosition<GeoCoordinate> Position
    {
        get;
        protected set;
    }
