...
{
    private readonly GeoLocationAccuracy m_desiredAccuracy;
    ...
    public GeoLocationProvider(GeoLocationAccuracy desiredAccuracy)
    {
        ...
        m_provider.StatusChanged += OnInternalStatusChanged;
    }
    ...
    public void Start()
    {
        ...
        if (!m_started)
        {
            if (m_provider != null)
            {
                m_provider.LocationChanged += OnInternalLocationChanged;
    ...
    private void OnInternalLocationChanged(object sender, GeoLocationChangedEventArgs e)
    {
        if (e.Location != null)
        {
            Utility.Trace("GeoLocationProvider.OnInternalLocationChanged: " + e.Location.Coordinate);
            //
    ...
    {
        Utility.Trace("GeoLocationProvider.OnLocationChanged: " + e.Location.Coordinate);
    ...
    {
        Utility.Trace("GeoLocationProvider.OnStatusChanged: " + e.Status);
        var t = StatusChanged;
        if (t != null)
        {
            t(this, e);
