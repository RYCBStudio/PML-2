    ...
    GeoCoordinateWatcherBase, ILocationEvents, IDisposable
{
    ...
    //
    private void GetLocationData(object state) => GetLocationHelper();
    ...
    private static readonly GeoPositionStatus[] m_geoStatusMap =
    [
    ...
    private void ExitProcessing() => Interlocked.Decrement(ref m_positionEventsProcessingCount);
    ...
    private bool NoPositionEventsCurrentlyProcessing() => Volatile.Read(ref m_positionEventsProcessingCount) == 0;
