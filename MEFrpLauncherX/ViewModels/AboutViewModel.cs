...
public class AboutViewModel : ViewModelBase
{
    ...
    public ObservableCollection<OpenSourceLibrary> OpenSourceLibraries { get; } =
    [
        ...
        new() { Name = "MessageBox.Avalonia", Url = "https://github.com/AvaloniaCommunity/MessageBox.Avalonia", License = "MIT" },
        ...
        new() { Name = "AsyncImageLoader.Avalonia", Url = "https://github.com/AvaloniaUtils/AsyncImageLoader.Avalonia", License = "MIT" },
        ...
        new() { Name = "Microsoft PinYinConverter", Url = "https://www.nuget.org/packages/Microsoft.International.Converters.PinYinConverter", License = "Microsoft" },
